...
test("1.07 dollars should be 156.5 Yens", function() {
    ...
    // If 1.07 dollar is 156.6 Yen, then 5 dollars should be = ((5 / 1.07) * 1.56.5)
    const expected = (5 / 1.07) * 156.5 ;
    
    // This is the comparison for the unit test
     expect(yen).toBe(expected); // 1.07 dollar is 156.6 Yen, then 5 dollars should be = ((5 / 1.07) * 156.5)
})
...
test("156.5 yen should be 0.87 pounds", function() {
    ...
    // If 156.5 yen is 0.87 pound, then ...
    const expected = (100 / 156.5) * 0.87; 
    
    // This is the comparison for the unit test
     expect(pound).toBe(expected); // 156.5 yen is 0.87 pound, then ...
})